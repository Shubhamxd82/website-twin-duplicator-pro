...
export const LinkCard = ({ title, description, icon: Icon, href, delay = 0 }: LinkCardProps) => {
  return (
    <a
      ...
      className="group block w-full animate-fade-in"
      style={{ animationDelay: `${delay}ms` }}
    >
      <div className="glass-card flex items-center gap-4 p-4 rounded-2xl backdrop-blur-glass bg-glass border border-glass-border shadow-glass transition-all duration-300 hover:scale-105 hover:shadow-glow">
